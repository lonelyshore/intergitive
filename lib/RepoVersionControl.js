    ...
    [_copyToBackup](isBackupTemplate) {
        ...
        let serializeIndex = () => {
            if (isBackupTemplate) {
                ...
                .then((dataString) => {
                    return fs.writeFile(
                        path.join(this.storePath, RepoVersionControl.wrapperFolderName, RepoVersionControl.repoFolderName, RepoVersionControl.indexFileName)
                    );
                });
            }
            else {

...
let elaborateStepType = new yaml.Type('!elaborate', {
    ...
    construct: function(data) {
        return new step.ElaborateStep(data.descriptionId, data.needConfirm || true);
    },
...
let illustrateStepType = new yaml.Type('!illustrate', {
    ...
    construct: function(data) {
        return new step.IllustrateStep(data.descriptionId, data.needConfirm || true);
    },
...
let instructStepType = new yaml.Type('!instruct', {
    ...
    construct: function(data) {
        return new step.InstructStep(data.descriptionId, data.needConfirm || true);
    },

...
/**
 * !removeFile removes files mentioned in targetPaths.
...
let setRemoteActionType = new yaml.Type('!setRemote', {
    kind: 'mapping',
...
let pushActionType = new yaml.Type('!push', {
    kind: 'mapping',
...
let pushAllActionType = new yaml.Type('!pushAll', {
    kind: 'mapping',
    ...
    resolve: function(data) {
        return data !== null
            ...
            && 'remoteNickName' in data
            && isString(data.remoteNickName)
            && (!('isForce' in data) || typeof(data.isForce) === 'boolean');
    },
...
let needActionStepType = new yaml.Type('!needAction', {
    kind: 'mapping',
...
let devActionStepType = new yaml.Type('!devAction',  {
    kind: 'mapping',

...
class LoaderPair {
    /**
     * 
     * @param {MutableAssetLoader} globalLoader 
     * @param {MutableAssetLoader} courseLoader 
     */
...
function createCourseAssetLoaderPair(courseSettings) {
    let globalLoader = new MutableAssetLoader(courseSettings.resourcesPath);
    globalLoader.setBundlePath(...courseSettings.bundlePath);

    let courseLoader = new MutableAssetLoader(courseSettings.courseResourcesPath);
 ...
 */
function loadCourseText(stringKey, courseName, loaderPair) {
    let loader = loaderPair.course;
    loader.setBundlePath(courseName);
...
module.exports.loadCourseText = loadCourseText;
...
exports.RepoCheckpointManager = class RepoCheckpointManager {
    ...
    static create(monitoredPath, checkpointStorePath, storeName, storageType, isCrLf) {
        ...
        return ret[hiddenCtor](monitoredPath, checkpointStorePath, storeName, storageType, isCrLf || eol.isCrLf())
        .then(() => ret);
    }    
    ...
    [hiddenCtor](monitoredPath, checkpointStorePath, storeName, storageType, isCrLf) {
...
exports.RepoReferenceManager = class RepoReferenceManager {
    ...
    static create(monitoredPath, referenceStorePath, storeName, storageType, isCrLf) {
        ...
        return ret[hiddenCtor](monitoredPath, referenceStorePath, storeName, storageType, isCrLf || eol.isCrLf())
        .then(() => ret);
    }   
    ...
    [hiddenCtor](monitoredPath, referenceStorePath, storeName, storageType, isCrLf) {
...
exports.RepoReferenceMaker = class RepoReferenceMaker {
    ...
    static create(sourcePath, referenceStorePath, storeName, storageType, isCrLf) {
        ...
        return ret[hiddenCtor](sourcePath, referenceStorePath, storeName, storageType, isCrLf || eol.isCrLf())
        .then(() => ret);
    }

    [hiddenCtor](sourcePath, referenceStorePath, storeName, storageType, isCrLf) {
        this.backend = new vcs.RepoVersionControl(referenceStorePath, createStorage(storageType, isCrLf), isCrLf);

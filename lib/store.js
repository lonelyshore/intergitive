...
let store = {
    ...
    loadCourse(courseName) {
        ...
        this.courseState.displayingNode = null;
        ...
        .then(course => {
            return this.buildCourseTree(course)
            .then(courseTree => {
                this.courseState.courseTree = courseTree;
                this.courseState.displayingNode = this.courseState.courseTree;

...
exports.RepoVersionControl = class RepoVersionControl {
    ...
    [_compareWorkingTreeDiff](sourceRepo, referenceRepo) {
        ...
        .then(() => {
            return git.Diff.indexToWorkdir(sourceRepo, sourceIndex, Diff.OPTION.INCLUDE_UNTRACKED | Diff.OPTION.IGNORE_WHITESPACE_EOL)
            .then(result => {
                sourceDiff = result;
            })
            .then(() => git.Diff.indexToWorkdir(referenceRepo, referenceIndex, Diff.OPTION.INCLUDE_UNTRACKED | Diff.OPTION.IGNORE_WHITESPACE_EOL))
            .then(result => {

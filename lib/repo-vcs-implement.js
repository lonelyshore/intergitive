...
module.exports.RepoVersionControl = class RepoVersionControl {
    ...
    diffWithTemplate(tagName) {
        ...
        let areEqual = true;
        return this.storage.loadToCache(tagName)
        .catch(err => {
            if (!isBreaking) {
        ...
        .then(() => {
            if (!areEqual) {
                ...
                return this[_compareRepoIndex](sourceRepo, indexFilePath)
                .then(result => {
                    if (!result) {
                        areEqual = false;
                    }
        ...
        .then(() => {
            if (!areEqual) {
                ...
                return fs.remove(indexFilePath)
                .then(() => this[_compareWorkingTreeDiff](sourceRepo, referenceRepo, referenceWorkingPath))
                .then(result => {
                    if (!result) {
                        areEqual = false;
                    }
    ...
    [_compareRepoIndex](sourceRepo, indexFilePath) {

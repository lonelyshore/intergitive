...
function _sourceFileEqualsRefFile(sourceFilePath, refFilePath) {
    return Promise.all([
...
function _sourceDirtyWorkTreeEqualRefWorkTree(sourceDiff, sourcePath, refPath) {
...
exports.RepoVersionControl = class RepoVersionControl {
    ...
    [_compareWorkingTreeDiff](sourceRepo, referenceRepo) {
        ...
        .then(() => {
            return _sourceDirtyWorkTreeEqualRefWorkTree(sourceDiff, this.sourcePath, this.backupWorkTreePath);
        })
    }

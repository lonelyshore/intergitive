...
const autoplayStep = (Sup, isAutoStart) => {
    return class extends renderable(
        needProcess(interactable(Sup)), 
        'auto-play'
    ) {
...
class ExecuteActionStep extends autoplayStep(hasActionsStep(Step), false) {
    constructor(actions) {
        super();
...
class BaseVerifyRepoStep extends verifyStep(Step, 'verify-repo') {
...
class LoadReferenceStep extends autoplayStep(hasActionsStep(Step), true) {
...
class AutoPlayActionsStep extends autoplayStep(hasActionsStep(Step), true) {

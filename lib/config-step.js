...
class ExecuteActionStep extends blockingExecutionStep(hasActionsStep(Step), false) {
     ...
     */
    takeAction(store, stepKey) {
        return store.executeActions(store);
    }
}

class ElaborateStep extends interactableStep(Step, 'elaborate') {
    /**
     * 
...
class IllustrateStep extends interactableStep(Step, 'illustrate') {
    /**
     * 
     * @param {string} descriptionId 
     */
...
class VerifyInputStep extends interactableStep(Step, 'verify-input') {
    /**
     * 
     * @param {String} answer 
     * @param {String} descriptionId 
...
class BaseVerifyRepoStep extends interactableStep(Step, 'verify-repo') {
...
class LoadReferenceStep extends blockingExecutionStep(hasActionsStep(Step), true) {
...
class LoadLastLevelFinalSnapshotStep extends blockingExecutionStep(hasActionsStep(Step), true) {

    constructor(repoSetupNames) {
        super();
    ...
    takeAction(store, stepKey) {
        return store.LoadLastLevelFinalSnapshotStep(stepKey);
    }
}

...
const baseSequentialAction = (classTag) =>{
    return class extends Action {
        ...
        executeBy(actionExecutor) {
            let sequence = this.actions.reduce(
                (acc, current) => {
...
class PullAction extends baseSequentialAction('PullAction') {
    constructor(actions) {
        super(actions);
    }
}

class AddRevisionAction extends baseSequentialAction('AddRevisionAction') {
    constructor(actions) {
        super(actions);
    }
}
...
module.exports.PullAction = PullAction;
module.exports.AddRevisionAction = AddRevisionAction;

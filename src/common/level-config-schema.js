...
const sequentialActionType = new yaml.Type('!act.sequential', {
  kind: 'sequence',
  ...
  construct: function (data) {
    return new action.SequentialAction(data)
  },

  instanceOf: action.SequentialAction,
...
const writeFileActionType = new yaml.Type('!act.writeFile', {
  kind: 'mapping',
  ...
  instanceOf: action.WriteFileAction,
 ...
 *
 */
const removeFileActionType = new yaml.Type('!act.removeFile', {
  kind: 'mapping',
...
const moveFileActionType = new yaml.Type('!act.moveFile', {
  kind: 'mapping',
...
const debugLogActionType = new yaml.Type('!act.log', {
  kind: 'scalar',
...
const checkoutActionType = new yaml.Type('!act.checkout', {
  kind: 'mapping',
...
const stageActionType = new yaml.Type('!act.stage', {
  kind: 'mapping',
...
const stageAllActionType = new yaml.Type('!act.stageAll', {
  kind: 'mapping',
...
const commitActionType = new yaml.Type('!act.commit', {
  kind: 'mapping',
...
const mergeActionType = new yaml.Type('!act.merge', {
  kind: 'mapping',
...
const fetchActionType = new yaml.Type('!act.fetch', {
  kind: 'mapping',
...
const pullActionType = new yaml.Type('!act.pull', {
  kind: 'mapping',
  ...
  construct: function (data) {
    return new action.SequentialAction([
...
const addRevisionActionType = new yaml.Type('!act.addRevision', {
  kind: 'mapping',
...
const setRemoteActionType = new yaml.Type('!act.setRemote', {
  kind: 'mapping',
...
const pushActionType = new yaml.Type('!act.push', {
  kind: 'mapping',
...
const pushAllActionType = new yaml.Type('!act.pushAll', {
  kind: 'mapping',
...
const setUserActionType = new yaml.Type('!act.setUser', {
  kind: 'mapping',
...
const saveCheckpointActionType = new yaml.Type('!act.saveCheckpoint', {
  kind: 'mapping',
...
const loadCheckpointActionType = new yaml.Type('!act.loadCheckpoint', {
  kind: 'mapping',
...
const loadReferenceActionType = new yaml.Type('!act.loadReference', {
  kind: 'mapping',
...
const compareReferenceActionType = new yaml.Type('!act.compareReference', {
  kind: 'mapping',
...
const verifyInputStepType = new yaml.Type('!verifyInput', {
  kind: 'mapping',
...
const verifyRepoStepType = new yaml.Type('!verifyOneRepo', {
  kind: 'mapping',
...
const verifyAllRepoStepType = new yaml.Type('!verifyRepo', {
  kind: 'mapping',
...
const needActionStepType = new yaml.Type('!dev.needAction', {
  kind: 'mapping',
...
const devActionStepType = new yaml.Type('!dev.devAction', {
  kind: 'mapping',
...
const executeActionStepType = new yaml.Type('!execute', {
  kind: 'mapping',
  ...
  represent: function (step) {
    ...
    if (step.descriptionId !== undefined) ret.descriptionId = step.descriptionId
    if (step.appendCheckpoint !== undefined) ret.appendCheckpoint = step.appendCheckpoint
    if (step.resettingRepos !== undefined) ret.resettingRepos = step.resettingRepos

    return ret
  }
})

const autoPlayActionsStepType = new yaml.Type('!playActions', {
  kind: 'mapping',
...
const elaborateStepType = new yaml.Type('!elaborate', {
  kind: 'mapping',
...
const illustrateStepType = new yaml.Type('!illustrate', {
  kind: 'mapping',
...
const instructStepType = new yaml.Type('!instruct', {
  kind: 'mapping',
...
const partialCheckpointStepType = new yaml.Type('!partialCheckpoint', {
  kind: 'mapping',
...
const checkpointStepType = new yaml.Type('!checkpoint', {
  kind: 'mapping',
...
const loadReferenceStepType = new yaml.Type('!loadOneReference', {
  kind: 'mapping',
...
const loadAllReferenceStepType = new yaml.Type('!loadReference', {
  kind: 'mapping',
...
const loadLastLevelFinalSnapshotStep = new yaml.Type('!loadLastLevelFinalSnapshot', {
  kind: 'mapping',
...
const openWorkingPathStep = new yaml.Type('!openWorkingPath', {
  kind: 'mapping',
...
const completeLevelStep = new yaml.Type('!completeLevel', {
  kind: 'mapping',
...
const saveProgressStep = new yaml.Type('!saveProgress', {
  kind: 'mapping',
...
const repoVcsSetupType = new yaml.Type('!repoVcs', {
  kind: 'mapping',

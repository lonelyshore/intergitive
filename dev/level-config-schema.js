...
const unstageActionType = new yaml.Type(
...
const unstageAllActionType = new yaml.Type(
...
const mergeActionType = new yaml.Type(
...
const continueMergeActionType = new yaml.Type(
...
const cleanCheckoutActionType = new yaml.Type(
...
const gitCommandActionType = new yaml.Type(
...
const saveRepoReferenceActionType = new yaml.Type(
...
const loadRepoReferenceArchiveActionType = new yaml.Type(
...
const cloneRepoActionType = new yaml.Type(
...
const idleActionType = new yaml.Type(
...
const schema = yaml.Schema.create(upstream.LEVEL_CONFIG_SCHEMA, [
  unstageActionType,
